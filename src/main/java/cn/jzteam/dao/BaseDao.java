...
//    long updateSpecial(@Param("entity") T entity, @Param("query") QueryCondition query);
     ...
     * @return
     */
    List<T> selectByIds(@Param("list") List<PK> idList);
     ...
     * @return
     */
    T selectFirstOne(@Param("query") QueryCondition query);
     ...
     * @return
     */
    List<T> selectList(@Param("query") QueryCondition query);
     ...
     * @return
     */
    long queryPageCount(@Param("query") QueryCondition query);
     ...
     * @return
     */
    List<T> queryPageList(@Param("query") QueryCondition query);
